...
(function() {
  ...
  // ─── Service Catalog ───
  const SERVICES = [
    { id: 'sp-starter',   name: 'Spotify Starter Mix',        price: 12, platform: 'spotify',    category: 'package',   icon: 'headphones',   desc: '3K Plays + 100 Saves + 300 Followers',    url: 'spotify#packages',    gradient: 'linear-gradient(135deg, #1DB954 0%, #0a3d1f 100%)' },
    { id: 'sp-pro',       name: 'Spotify Pro Mix',             price: 90, platform: 'spotify',    category: 'package',   icon: 'headphones',   desc: 'Full promo package for serious releases',  url: 'spotify#packages',    gradient: 'linear-gradient(135deg, #1DB954 0%, #064e27 100%)' },
    ...
    { id: 'sc-starter',   name: 'SC Starter Pack',              price: 8,  platform: 'soundcloud', category: 'package',   icon: 'headphones',   desc: '1K Plays + 100 Likes + 100 Followers',     url: 'soundcloud#packages', gradient: 'linear-gradient(135deg, #FF5500 0%, #4d1900 100%)' },
